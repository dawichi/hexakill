        ...
        <div className='row'>
            ...
            <div className='col-6'>
                <ul className='border rounded p-3 inline-block'>
                    <li>
                        <i className='bi bi-journals'></i> {type(enemy.type)}
                    </li>
                    <li>
                        <i className='bi bi-vector-pen'></i> <span className='text-red-600 font-bold'>{enemy.dmg}</span>
                    </li>
                    <li>
                        <i className='bi bi-shield-shaded'></i> <span className='text-blue-600 font-bold'>{enemy.armor}</span>
                    </li>
                    <li>
                        <i className='bi bi-gift-fill'></i> <span className='text-green-600 font-bold'>{enemy.exp} exp</span>
                    </li>
                </ul>
            </div>
        </div>
